...
**Recommendation 4: Commercially valuable AIRR sequence data.** In exceptional circumstances, AIRR sequence data may be commercially valuable. Where there is an intent to commercialize AIRR sequence data and/or associated antibodies, data generators may be prevented from sharing those sequences/antibodies of potential value. In these cases, data generators are nevertheless encouraged to share the data using using individually/institutionally negotiated legal instrument(s). 
